...
function inscription(){
    ...
    if(empty($_POST['prenom'])) {
        $valid = 0;
        $error_message ="<div class='error' style='padding: 10px;background:#f1f1f1;margin-bottom:20px; border-radius: 5px;'>ajouter un prénom svp<br></div>";
                return $error_message;
    }
...
function inscriptionboutique(){
    ...
    if(empty($_POST['nom_b'])) {
        $valid = 0;
        $error_message ="<div class='error' style='padding: 10px;background:#f1f1f1;margin-bottom:20px; border-radius: 5px;'>Ajoutez le nom de votre boutique svp<br></div>";
                return $error_message;
    }
    ...
    if(empty($_POST['CNI'])) {
        $valid = 0;
       $error_message ="<div class='error' style='padding: 10px;background:#f1f1f1;margin-bottom:20px; border-radius: 5px;'>Ajoutez votre CNI<br></div>";
                return $error_message;
    }

    if(empty($_POST['NUMREG'])) {
        $valid = 0;
        $error_message ="<div class='error' style='padding: 10px;background:#f1f1f1;margin-bottom:20px; border-radius: 5px;'>Ajouter le numéro de votre res de com<br></div>";
                return $error_message;
    }
